...
from extract_foreground import *
...
output_dir = "/usr/prakt/s0075/image-editing/code/outputs/foreground/safety_car-out.png"

# load the original image with alpha
orig_im = Image.open(input_dir).convert("RGBA")
foregreound_img = extract_foreground(input_dir)
foregreound_img.save("/usr/prakt/s0075/image-editing/code/outputs/foreground/safety_car-foregreound_img.png")

resized_img, white_bg_image = scale_and_paste(foregreound_img)
resized_img.save("/usr/prakt/s0075/image-editing/code/outputs/foreground/safety_car-resized_img.png")
white_bg_image.save("/usr/prakt/s0075/image-editing/code/outputs/foreground/safety_car-white_bg_image.png")

# load preprocessor and generate depth map
image_zoe = zoe(white_bg_image, detect_resolution=512, image_resolution=1024)   # TODO:takes long
image_zoe.save("/usr/prakt/s0075/image-editing/code/outputs/foreground/safety_car-image_zoe.png")
